...
function sqlArray( $queryString ) {
	...
	LATER NOTE . . . I don't think user queries use think function ever anymore. Should recheck if they do, but if they don't - there's nothing to fix here, I believe it's just an internal service function already.
