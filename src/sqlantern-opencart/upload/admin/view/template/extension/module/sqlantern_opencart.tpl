		...
		<div class="container-fluid">
			...
			<ul class="breadcrumb">
				<?php foreach ($breadcrumbs as $b) { ?>
					<li><a href="<?php echo $b["href"]; ?>"><?php echo $b["text"] ?></a></li>
				<?php } ?>
			</ul>
		</div>
	</div>
				...
				<form action="<?php echo $action; ?>" method="post" id="form-module" class="form-horizontal">
					<div class="form-group">
						<label class="col-sm-2 control-label">
							<span data-toggle="tooltip" title="<?php echo $text_status_hint; ?>"><?php echo $text_status; ?></span>
						</label>
						<div class="col-sm-2">
							<?php
								$enabled_selected = "";
							...
							?>
							<select name="module_sqlantern_status" class="form-control">
